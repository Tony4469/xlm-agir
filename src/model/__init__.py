    ...
    if params.encoder_only:
        ...
        if params.reload_model != '':
            ...
            if enc_path != '':
                ...
                enc_reload = torch.load(enc_path, map_location={'cuda:0': 'cpu'}) #map_location: lambda storage, loc:storage.cuda(params.local_rank) Souf
            ...
            if dec_path != '':
                ...
                dec_reload = torch.load(dec_path, map_location={'cuda:0': 'cpu'}) #map_location: lambda storage, loc:storage.cuda(params.local_rank) Souf
        ...
        return encoder, decoder #encoder.cuda(), decoder.cuda()
